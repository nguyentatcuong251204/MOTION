...
import sys
sys.path.append('/dino')  # Thay bằng đường dẫn thực tế của thư mục DINO
...
raft_args = parser.parse_args(['--model', '/home/nguyentatcuong251204/RAFT_clone/models/raft-things.pth', 
